...
# automatically redirect / to a notebook by editing the following line:
echo "c.NotebookApp.default_url = '/notebooks/hello-tmpenv.ipynb'" >> ~/.jupyter/jupyter_notebook_config.py
